...
c---------------------------------------------------------------------
     ...
     >                        buf(i,4)*ue(i,4))
             ...
             do  i = 1, grid_points(1)-2
                ...
                forcing_r(i,j,k,1) = forcing_r(i,j,k,1) -
     >                 tx2*( ue(ip1,2)-ue(im1,2) )+
     >                 dx1tx1*(ue(ip1,1)-2.0d0*ue(i,1)+ue(im1,1))

                forcing_r(i,j,k,2) = forcing_r(i,j,k,2) - tx2 * (
...
c---------------------------------------------------------------------
             do   m = 1, 5
                i = 1
                forcing_r(i,j,k,m) = forcing_r(i,j,k,m) - dssp *
...
c---------------------------------------------------------------------
     ...
     >                dz4tz1*( ue(kp1,4)-2.0d0*ue(k,4) +ue(km1,4))
                ...
                forcing_r(i,j,k,5) = forcing_r(i,j,k,5) - tz2 * (
...
c---------------------------------------------------------------------
       do   k = 1, grid_points(3)-2
          do   j = 1, grid_points(2)-2
             do   i = 1, grid_points(1)-2
                do   m = 1, 5
                   forcing_r(i,j,k,m) = -1.d0 * forcing_r(i,j,k,m)
                end do
             end do
          end do
       end do
